...
export const ComedyFilms = () => {
  ...
  const {data} = useGetComedyFilmsQuery({
    page: page,
  ...
  return (
    <section className="catalog">
      <div className="container wrapper catalog__container">
        ...
        <Title classN="catalog__title">250 лучших комедий</Title>
        <p className="catalog__desc">Лучшие комедии для просмотра всей семьей. Рейтинг составлен по результатам голосования посетителей сайта. Любой желающий может принять в нем участие, проголосовав за свой любимый фильм.</p>
